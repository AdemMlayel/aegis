...
Check_binaries
    ...
    ${df_html}    ${val_result}    Call Method    ${val_tc43_obj}    get_validation_results    ${node_file_map}
    Log               <table>${df_html}</table>    html=True
    Should Be True    ${val_result}
...
FTAS_software_verification
    ...
    ${df_html}    ${val_result}    Call Method    ${ims_tc44_obj}    get_validation_results    ${node_file_map}
    Log               <table>${df_html}</table>    html=True
    Should Be True    ${val_result}